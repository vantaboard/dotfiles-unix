...
bash -n "${REPO_ROOT}/scripts/lib/host.sh"
echo "OK: ${REPO_ROOT}/scripts/lib/host.sh"
...
bash -n "${REPO_ROOT}/tests/host-kind.sh"
echo "OK: ${REPO_ROOT}/tests/host-kind.sh"
bash "${REPO_ROOT}/tests/host-kind.sh"
bash -n "${REPO_ROOT}/scripts/lib/apt-manual.sh"
echo "OK: ${REPO_ROOT}/scripts/lib/apt-manual.sh"
bash -n "${REPO_ROOT}/scripts/apt-manual-sync"
echo "OK: ${REPO_ROOT}/scripts/apt-manual-sync"
bash -n "${REPO_ROOT}/scripts/lib/pkg-manual.sh"
